...
import com.example.manytomanyemailverificationwithtoken.model.MailProperties;
...
public class SendingMailService {
    ...
    private boolean sendMail(String toEmail, String subject, String body){
        try{
            ...
            msg.setFrom(new InternetAddress(mailProperties.getForm(), mailProperties.getFormName()));
