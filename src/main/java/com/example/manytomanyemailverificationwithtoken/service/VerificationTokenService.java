package com.example.manytomanyemailverificationwithtoken.service;

import com.example.manytomanyemailverificationwithtoken.model.User;
import com.example.manytomanyemailverificationwithtoken.model.VerificationToken;
import com.example.manytomanyemailverificationwithtoken.repository.UserRepository;
import com.example.manytomanyemailverificationwithtoken.repository.VerificationTokenRepository;
...
public class VerificationTokenService {
    ...
    public ResponseEntity<String> verifyEmail(String token){
        ...
        if (verificationToken.getExpiredDateTime().isBefore(LocalDateTime.now())){
            return ResponseEntity.unprocessableEntity().body("Expried token.");
        }
        verificationToken.setConfirmedDateTime(LocalDateTime.now());
        verificationToken.setStatus(VerificationToken.STATUS_PENDING);
        verificationToken.getUser().setIsActive(true);
        verificationTokenRepository.save(verificationToken);
        return ResponseEntity.ok("You have succsessfully verified your email address.");
    }
